<template>
	<v-dialog v-model="show" max-width="290" persistent>
      <v-card class="cstm-border-radius pa-5 py-10 dialog__con">
        <v-img :src="$PRXConfig().staticUrl('icons/prompt.svg')" class="mx-auto text-center" width="70px" height="70px"></v-img>
        <v-card-title class="px-7 pt-3 pb-32 justify-center"><h2 class="mb-0 text-center">Oops!</h2></v-card-title>
